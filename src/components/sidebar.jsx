      ...
      <div class="h-full px-3 pb-4 overflow-y-auto  bg-[#212137] dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
          <li>
            <a
              href="#"
              class="flex items-center p-2 text-white rounded-lg dark:text-white hover:text-[#212137] hover:bg-gray-100 dark:hover:bg-gray-700 group"
            >
              <svg
          ...
          <li>
            ...
            >
              ...
              <span class="flex-1 ms-3 whitespace-nowrap">Noticeboard</span>
            </a>
          </li>
          <li>
            <a
